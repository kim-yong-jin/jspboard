    	...
    	<section class="content">
    	  <div class="card">    		
    	  	<div class="card-header with-border">
    	  		<button type="button" class="btn btn-secondary" 	onclick="OpenWindow('registForm.do','회원등록',800,700);" >회원등록</button>
				  ...
				  <!-- sort num -->
				 	...
				 	<input type = "text" class = "form-control" name = "keyword" placeholder="검색어를 입력하세요." value = "${cri.keyword }"/>
				 	
				 	<span class = "input-group-append">
				 			<button class = "btn btn-secondary" type = "button" id = "searchBtn" data-card-widget = "search" onclick = "searchList_go(1);">
    		  ...
    		  <div class="row">
	             <div class="col-sm-12">	
		    		<table class="table table-bordered">
		                ...
		                <tr>
							<td>
								<a href = "javascript:OpenWindow('detail.do?id=${member.id}','회원상세보기',800,900);">${member.id}</a>
							</td>		                
